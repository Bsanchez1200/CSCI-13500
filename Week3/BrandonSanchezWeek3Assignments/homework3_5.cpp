...
int main() {
  ...
  // Declare a non-zero 3x3 vector, then assign values row by row
  std::vector<std::vector<int> > vec3(n3, std::vector<int>(n3, 0));
  vec3[0][0] = 1;  vec3[0][1] = 2;  vec3[0][2] = 3;
  vec3[1][0] = 4;  vec3[1][1] = 5;  vec3[1][2] = 6;
  vec3[2][0] = 7;  vec3[2][1] = 8;  vec3[2][2] = 9;
  ...
  // Declare a non-zero 3x3 vector, then assign values row by row
  std::vector<std::vector<int> > vec4(n4, std::vector<int>(n4, 0));
  vec4[0][0] = 2;  vec4[0][1] = 1;  vec4[0][2] = 3;
  vec4[1][0] = 0;  vec4[1][1] = 4;  vec4[1][2] = 0;
  vec4[2][0] = 1;  vec4[2][1] = 2;  vec4[2][2] = 5;
